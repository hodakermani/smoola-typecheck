		...
		try {
			...
			case 1:
				...
				((ExpressionAssignmentContext)_localctx).rAssignExpr = expressionAssignment();
						    ...
						    ((ExpressionAssignmentContext)_localctx).assignRetExpr =  new BinaryExpression( ((ExpressionAssignmentContext)_localctx).lOrExpr.orExpr , ((ExpressionAssignmentContext)_localctx).rAssignExpr.assignRetExpr, BinaryOperator.assign, ((ExpressionAssignmentContext)_localctx).lOrExpr.orExpr.getType() );
				            print(_localctx.assignRetExpr.getLeft().getType());
